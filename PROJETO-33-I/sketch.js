...
function setup() {
  ...
  //1º corda 
  rope = new Rope(5,{x:230,y:300});
  //criar a 2º corda
  rope2 = new Rope(3,{x:50,y:500})  
...
function draw() {
  ...
  ground.show();
  higherground.show();
  //mostra a primeira corda
  rope.show();
  //mostrar a segunda corda
  rope2.show()
...
//função que corta a 1º corda
function drop1(){
  rope.break();
  con.dettach();
  con = null; 
}
//criar a função que corta a 2º corda
function drop2(){
  rope2.break()
  con2.dettach()
  con2=null
